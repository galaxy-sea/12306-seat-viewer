...
[![Greasy Fork Version](https://img.shields.io/greasyfork/v/584065?style=flat-square)](https://greasyfork.org/zh-CN/scripts/584065)
...
## 静态网页
`site/` 目录提供一个可独立部署的静态页面，用于按日期和车次查询动车座位图片。
